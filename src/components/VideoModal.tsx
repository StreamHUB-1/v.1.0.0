...
import { X, Eye, AlertTriangle, Disc, Play } from 'lucide-react'; // Tambahkan Play untuk FancyButton
import { Video } from '../types';

// FANCY BUTTON KITA PINDAHKAN KESINI AGAR TIDAK ERROR CIRCULAR DEPENDENCY
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-5xl bg-gray-900 border border-gray-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[80vh] animate-[scaleIn_0.2s_ease-out]">
        ...
        <div className="w-full md:w-[60%] h-64 md:h-auto relative flex-shrink-0 bg-black">
          <img 
          ...
          <div className="absolute bottom-8 left-8 z-20">
             ...
             <h2 className="text-2xl md:text-4xl font-black text-white leading-tight uppercase mb-2 line-clamp-2">
                {video.title}
             </h2>
          </div>
        </div>
        ...
        <div className="flex-1 p-8 md:p-10 flex flex-col overflow-y-auto custom-scrollbar relative bg-gray-900">
            ...
            <div className="hidden md:flex justify-end mb-6">
                <button 
                onClick={onClose}
                className="p-2 text-gray-500 hover:text-white transition-colors bg-gray-800 rounded-full"
                >
                <X size={20} />
                </button>
            </div>
            ...
            <div className="mt-auto flex flex-col items-center gap-4">
                {/* Memanggil FancyButton yang sudah ada di file ini */}
                <div className="w-full flex justify-center scale-110 md:scale-125 py-4">
                    <FancyButton onClick={() => onWatch(video)} label="Go to Link!!!" />
                </div>
